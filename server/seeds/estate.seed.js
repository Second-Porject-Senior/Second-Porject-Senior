...
// //         description: ' Stylish 1-bedroom loft with industrial design, exposed brick walls, and high ceilings. Located in the arts district.',
// //         price: 250.00,
// //         location: 'Downtown',
// //         bathrooms: 1,
// //         bedrooms: 1,
// //         area: 70.0,
// //         image_url: 'https://thumbs.cityrealty.com/smart/1024x/webp/e/b2/2689838/6e2dab878b57299ce6ab7f36c80bcce7-aa4b90430463e6d61d8f8e4e4f2b27d8.jpg',
// //         category_id: categories.find(c => c.name === 'Studios and 1 Bedrooms').id,
// //       },
// //       {
...
//         bedrooms: 1,
//         area: 45.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fHN0dWRpbyUyMGFwYXJ0bWVudHxlbnwwfHx8fDE2ODExMTYyNzA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Studios and 1 Bedrooms').id,
//       },
//       {
//         title: 'Chic City Loft',
...
//         bedrooms: 1,
//         area: 70.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154350-0c7f1a7a7a6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGxvZnQlMjBhcGFydG1lbnR8ZW58MHx8fHwxNjgxMTE2Mjcw&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Studios and 1 Bedrooms').id,
//       },
//       {
//         title: 'Luxury Apartment',
...
//         bedrooms: 3,
//         area: 120.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDN8fGFwYXJ0bWVudHxlbnwwfHx8fDE2ODExMTYyNzA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Apartments').id,
//       },
//       {
//         title: 'Elegant Villa',
...
//         bedrooms: 5,
//         area: 300.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDR8fHZpbGxhfGVufDB8fHx8MTY4MTExNjI3MA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Villas and Houses').id,
//       },
//       {
//         title: 'Penthouse with Panoramic Views',
...
//         bedrooms: 4,
//         area: 200.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDV8fHBlbnRob3VzZXxlbnwwfHx8fDE2ODExMTYyNzA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Penthouses').id,
//       },
//       {
//         title: 'Daily Rental Building',
...
//         bedrooms: 1,
//         area: 50.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDZ8fGRhaWx5JTIwcmVudGFsfGVufDB8fHx8MTY4MTExNjI3MA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Daily Rental Buildings').id,
//       },
//       {
//         title: 'Beachfront Vacation Home',
...
//         bedrooms: 4,
//         area: 180.0,
//         image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDd8fGJlYWNoZnJvbnQlMjBob21lfGVufDB8fHx8MTY4MTExNjI3MA&ixlib=rb-4.0.3&q=80&w=1080',
//         category_id: categories.find(c => c.name === 'Vacation Homes').id,
//       },
//     ];
  ...
  try {
    ...
    const estates = [
      // Studios and 1 Bedrooms
      {
        ...
        bedrooms: 1,
        area: 45.0,
        image_url: 'https://images.unsplash.com/photo-1600585154340-be6161c2a7a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
        category_id: categories.find(c => c.name === 'Studios and 1 Bedrooms').id,
      },
      {
        title: 'Chic City Loft',
